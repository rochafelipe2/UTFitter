let express = require('express'),
    ...
    Publicacao = require(path.join(__dirname,'/model/Publicacao')),
    Seguidor = require(path.join(__dirname,'/model/Seguidor')),
    Util = require(path.join(__dirname,'/public/Util'))
    app = express();
